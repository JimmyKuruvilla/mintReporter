...
export const BANK_CREDIT_TYPES = ['ach_credit', 'deposit', 'check_deposit', 'partnerfi_to_chase', 'misc_credit', 'wire_incoming', 'refund_transaction'];
export const BANK_DEBIT_TYPES = ['ach_debit', 'deposit_return', 'atm', 'check_paid', 'chase_to_partnerfi', 'fee_transaction', 'debit_card', 'quickpay_debit', 'wire_outgoing', 'fee_transaction'];
