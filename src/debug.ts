...
export const logDebugOutput = (originalDebits: Transaction[], originalCredits: Transaction[], debits: Transaction[], credits: Transaction[]) => {
  ...
  fs.writeFileSync(debugOutputFilePath('credits.ignored'), JSON.stringify(ignoredCredits, null, 2))
  ...
  fs.writeFileSync(debugOutputFilePath('debits.ignored'), JSON.stringify(ignoredDebits, null, 2))
  ...
  fs.writeFileSync(debugOutputFilePath('credits.uncategorizable'), JSON.stringify(uncategorizableCredits, null, 2))
